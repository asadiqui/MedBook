...
import { Mail, Clock, Calendar, Award } from "lucide-react";

interface DoctorAccountStatsProps {
  userData: {
...
export const DoctorAccountStats: React.FC<DoctorAccountStatsProps> = ({ userData, doctorData }) => {
  return (
