...
export default function DoctorLayout({
	...
	const avatarLetter = useMemo(() => {
		const first = (me?.firstName || "").trim();
		return (first.slice(0, 1) || "D").toUpperCase();
	}, [me?.firstName]);
						...
						<ul className="space-y-1.5">
							<li>
								<SidebarLink
									...
									label="Dashboard"
									icon="dashboard"
									active={active("/doctor/dashboard")}
								/>
							</li>
							<li>
								<SidebarLink
									...
									label="Appointments"
									icon="appointments"
									active={active("/doctor/appointments")}
								/>
							</li>
							<li>
								<SidebarLink
									...
									label="Availability"
									icon="availability"
									active={active("/doctor/availability")}
								/>
							</li>
							<li>
								<SidebarLink
